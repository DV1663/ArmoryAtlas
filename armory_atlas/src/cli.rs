...
#[derive(Parser)]
#[command(author, version, about = "A tool for managing the Armory Atlas database and inventory system")]
pub struct Command {
    #[arg(short, long, help = "The user to use when connecting to the database. Note that this will override whats written in the config file")]
    pub user: Option<String>,
    #[arg(short = 'H', long, help = "The host to use when connecting to the database. Note that this will override whats written in the config file")]
    pub host: Option<String>,
    #[arg(short, long, help = "The database to use when connecting to the database. Note that this will override whats written in the config file")]
...
pub enum CommandType {
    ...
    Config(AppConfig),
    #[command(about = "Subcommands for generating the diffrent kind of data for the database, everything except for Products and the ID's for the items are generated by the app, ID's are delt with by the database")]
    Generate(GenerateArgs),
    #[command(about = "Subcommands for managing the database, such as creating or dropping tables, triggers, procedures, functions and views")]
    Manage(ManageArgs),
...
pub struct InsertLoanArgs {
    ...
    #[arg(short, long, long_help = "The date that the loan was returned. This should only be used if the loan was made before this system was implemented!")]
    pub return_date: Option<NaiveDate>,
}

#[derive(Args, Debug, Clone)]
pub struct InsertProductArgs {
    #[arg(help = "The ID of the product to insert. Must be unique and no longer then 16 chars long!")]
    pub product_id: String,
